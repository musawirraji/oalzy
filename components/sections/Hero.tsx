...
const Hero = () => {
  return (
    <div className='bg-[url(/hero-mobile.png)] md:bg-[url(/hero.png)] bg-no-repeat bg-cover sm:bg-cover min-h-screen flex min-sm:items-center text-white px-4 '>
      <div className='min-sm:max-w-[840px] max-w-[320px]  max-sm:mx-auto flex flex-col space-y-5 min-sm:pl-56 max-sm:text-center max-sm:items-center  max-sm:pt-20 pt-10'>
        <h1 className='text-[42px] sm:text-[48px] max-sm:leading-12'>
        ...
        <h1 className='text-[30px] sm:text-[48px] leading-10'>
          Get 50% discount
        </h1>
